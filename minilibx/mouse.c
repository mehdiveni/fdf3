...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/08 23:16:48 by emoumni           #+#    #+#             */
/*   Updated: 2023/05/17 15:26:35 by emoumni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_mouse_move(int x, int y, void *params)
{
	...
	{
		env->camera->x_angle += (y - env->mouse->prev_y) * 0.004;
		env->camera->y_angle += (x - env->mouse->prev_x) * 0.004;
